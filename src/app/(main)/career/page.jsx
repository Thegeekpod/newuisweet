...
const CareerPage = async ({ searchParams }) => {
    ...
    const projects = await prisma.jobPost.findMany({
        orderBy: {
            id: 'desc',
        },
    ...
    const totalProjects = await prisma.jobPost.count();
            ...
            <div className="rounded-2xl bg-white p-6 shadow dark:bg-black dark:shadow-dark lg:col-span-2 lg:p-10">
                <div>
                    <h2 className="text-2xl font-semibold text-dark dark:text-light">
                        Join Our Innovative  <span className="text-primary">Tech Team</span>
                    </h2>
                    <p className="mt-4 text-lg text-muted dark:text-light/70">
                        Join our dynamic team at Sweet developers, where innovation meets opportunity. We empower our employees to grow, learn, and shape the future of technology. Explore exciting career paths and build a rewarding future with us!
                    </p>
                </div>
                ...
                <div className="mt-10 lg:mt-14">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        {projects.map((project) => (
                            <div key={project.id} className="group relative overflow-hidden rounded-lg bg-light p-4 pb-0 dark:bg-dark-2 md:p-6 xl:p-6">
                                ...
                                <div className="flex flex-wrap items-start justify-between py-2 align-center">
                                    <div>
