...
const Articales = ({data}) => {
  return (
    <div className="group rounded-2xl bg-white px-6 pt-0 shadow dark:bg-black dark:shadow-dark">
        ...
        <div className="max-h-[208px] space-y-4 overflow-hidden pb-6 pt-4 mb-8 [&::-webkit-scrollbar-thumb]:bg-gray-400 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:w-0">
        {data.map((item) => (
          <div
            key={item.slug}
